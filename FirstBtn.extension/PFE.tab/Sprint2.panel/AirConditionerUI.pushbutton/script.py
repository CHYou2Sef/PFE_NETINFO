...
#f = open("C:\\Users\\YOUSSEF\\PFE\\TotalPower.txt", "r")
f = open("Y:\\0000\\Etud\\pythonRevit\\FirstBtn.extension\\lib\\DB\\TotalPower.txt", "r")
...
#
# # open the CSV file
# with open("Y:\\0000\\Etud\\pythonRevit\\FirstBtn.extension\\lib\\DB\\Air_condition_dataset.csv") as csv_file:
#
